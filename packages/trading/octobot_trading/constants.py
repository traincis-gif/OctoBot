...
# Order creation
ORDER_DATA_FETCHING_TIMEOUT = 60  # optimized: 300s → 60s
ACTIVE_ORDER_STRATEGY_SWAP_TIMEOUT = 30  # optimized: 120s → 30s
...
CREATED_ORDER_FORCED_UPDATE_PERIOD = 1  # optimized: 5s → 1s for faster order state sync
...
EXPECTED_PORTFOLIO_UPDATE_TIMEOUT = 15  # optimized: 60s → 15s for faster portfolio sync
...
FAILED_NETWORK_REQUEST_RETRY_ATTEMPTS = 3  # optimized: 5 → 3
FAILED_PROXY_NETWORK_REQUEST_RETRY_ATTEMPTS = 1  # optimized: 2 → 1
TOOLS_FAILED_NETWORK_REQUEST_ATTEMPTS = int(os.getenv("TOOLS_FAILED_NETWORK_REQUEST_ATTEMPTS", "2"))
TOOLS_FAILED_NETWORK_REQUEST_RETRY_DELAY = int(os.getenv("TOOLS_FAILED_NETWORK_REQUEST_RETRY_DELAY", "2"))  # optimized: 5s → 2s
DEFAULT_REQUEST_TIMEOUT = int(os.getenv("DEFAULT_REQUEST_TIMEOUT", "10000"))  # optimized: 20s → 10s
...
EXCHANGE_WS_PROXY_AUTHENTICATED_URL = os.getenv("EXCHANGE_WS_PROXY_AUTHENTICATED_URL")
EXCHANGE_WSS_PROXY_AUTHENTICATED_URL = os.getenv("EXCHANGE_WSS_PROXY_AUTHENTICATED_URL")
EXCHANGE_WS_SOCKS_PROXY_AUTHENTICATED_URL = os.getenv("EXCHANGE_WS_SOCKS_PROXY_AUTHENTICATED_URL")
USE_AUTHENTICATED_EXCHANGE_REQUESTS_ONLY_PROXY = os_util.parse_boolean_environment_var("USE_AUTHENTICATED_EXCHANGE_REQUESTS_ONLY_PROXY", "False")
...
MAX_ALLOWED_CONSECUTIVE_CREDENTIALS_ERROR_MINUTES = float(os.getenv(
    "MAX_ALLOWED_CONSECUTIVE_CREDENTIALS_ERROR_MINUTES", "60"
))
...
AUTH_UPDATE_DEBOUNCE_DURATION = float(os.getenv("AUTH_UPDATE_DEBOUNCE_DURATION", "2"))  # optimized: 10s → 2s
...
INDIVIDUAL_ORDER_SYNC_TIMEOUT = 20  # optimized: 60s → 20s
